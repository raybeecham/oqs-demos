...
from tls_perf_test import tls_perf
from alg_perf_test import alg_perf
import subprocess
import os
import requests
...
app.register_blueprint(tls_perf, url_prefix="/tls-perf")
app.register_blueprint(alg_perf, url_prefix="/alg-perf")
